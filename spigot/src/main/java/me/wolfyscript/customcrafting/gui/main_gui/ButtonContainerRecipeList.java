        ...
        if (clickEvent.isShiftClick() && customRecipe != null) {
            ...
            if (clickEvent.isLeftClick()) {
                try {
                    ...
                    Bukkit.getScheduler().runTaskLater(customCrafting, () -> guiHandler.openWindow(new NamespacedKey(ClusterRecipeCreator.KEY, cache.getRecipeCreatorCache().getRecipeType().toString())), 1);
