 ...
 * It accepts loaded recipes from the [ResourceLoader][com.wolfyscript.customcrafting.core.resource.ResourceLoader].
 *
 */
interface RecipeManager : ResourceListener {
    ...
    companion object {
        ...
        fun createNew(customCrafting: CustomCrafting): RecipeManager {
            return RecipeManagerCommon(customCrafting)
        }
    ...
    val recipesLoadedByCC: Set<Key>

    val disabledRecipes: Set<Key>

    val invalidRecipes: List<VerificationResult<CustomRecipe<*, *>>>
