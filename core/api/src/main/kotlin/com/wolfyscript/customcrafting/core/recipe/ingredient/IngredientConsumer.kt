 ...
 *
 * This component is part of a [Registry][com.wolfyscript.customcrafting.core.registry.CustomCraftingRegistryTypes.ingredientConsumers], so third-parties can add their own custom consumers.
 */
...
fun Keep.Companion.of(modifier: RecipeItemModifier) : Keep = IngredientConsumerKeepImpl(modifier)

fun Replace.Companion.of(replacement: ItemStackRef) : Replace = IngredientConsumerReplaceImpl(replacement)

fun Consume.Companion.of(remains: IngredientRemainder) : Consume = IngredientConsumerConsumeImpl(remains)
