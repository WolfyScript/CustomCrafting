...
internal class ProcessGrindingDefaultImpl(
    ...
    override fun compute(
        ...
        val recipe = recipeEvaluationResult.recipe.value ?: return ItemStack.EMPTY.wrap()
        val player = context.player?.unwrap() as? ServerPlayer ?: return ItemStack.EMPTY.wrap()
