...
abstract class AbstractDestination<T: DestinationSettings>(val customCrafting: CustomCrafting, val resourceLoaderImpl: ResourceLoaderImpl, override val settings: T) : ResourceLoader.Destination {
