...
import me.wolfyscript.customcrafting.gui.main_gui.buttons.SettingsButtonLanguage;
import me.wolfyscript.customcrafting.gui.main_gui.buttons.SettingsButtonLockdown;
...
public class Settings extends CCWindow {
    ...
    @Override
    public void onInit() {
        registerButton(new SettingsButtonLockdown(api, customCrafting));
        registerButton(new SettingsButtonLanguage(availableLangs, api, customCrafting));
    ...
    public void onUpdateAsync(GuiUpdate<CCCache> event) {
        ...
        if (ChatUtils.checkPerm(player, "customcrafting.cmd.lockdown")) {
            event.setButton(9, SettingsButtonLockdown.KEY);
        }
        ...
        if (ChatUtils.checkPerm(player, "customcrafting.cmd.settings")) {
            ...
            event.setButton(13, SettingsButtonLanguage.KEY);
