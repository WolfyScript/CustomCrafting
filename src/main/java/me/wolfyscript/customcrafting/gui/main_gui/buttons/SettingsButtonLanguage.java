...
public class SettingsButtonLanguage extends ActionButton<CCCache> {

    public static final String KEY = "language";

    public SettingsButtonLanguage(List<String> availableLangs, WolfyUtilities api, CustomCrafting customCrafting) {
