...
public class PriorityButton extends ActionButton<CCCache> {
    ...
    public PriorityButton() {
        super("priority", new ButtonState<>("recipe_creator", "priority", PlayerHeadUtils.getViaURL("b8ea57c7551c6ab33b8fed354b43df523f1e357c4b4f551143c34ddeac5b6c8d"), (cache, guiHandler, player, inventory, slot, event) -> {
