...
public class HiddenButton extends ToggleButton<CCCache> {
    ...
    public HiddenButton() {
        super(RecipeCreatorCluster.HIDDEN.getKey(), (cache, guiHandler, player, guiInventory, i) -> cache.getRecipe().isHidden(), new ButtonState<>(RecipeCreatorCluster.HIDDEN_ENABLED, PlayerHeadUtils.getViaURL("ce9d49dd09ecee2a4996965514d6d301bf12870c688acb5999b6658e1dfdff85"), (cache, guiHandler, player, inventory, slot, event) -> {
