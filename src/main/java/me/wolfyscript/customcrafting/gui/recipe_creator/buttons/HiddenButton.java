...
public class HiddenButton extends ToggleButton<CCCache> {
    ...
    public HiddenButton() {
        super("hidden", update -> update.getGuiHandler().getCustomCache().getRecipe().isHidden(), new ButtonState<>("recipe_creator", "hidden.enabled", PlayerHeadUtils.getViaURL("ce9d49dd09ecee2a4996965514d6d301bf12870c688acb5999b6658e1dfdff85"), (cache, guiHandler, player, inventory, slot, event) -> {
