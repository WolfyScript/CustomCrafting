...
public class CraftingEliteCreator extends RecipeCreator {
    ...
    public void onInit() {
        ...
        registerButton(new ToggleButton<>(RecipeCreatorCluster.SHAPELESS, (cache, g, p, gui, i) -> cache.getRecipeCreatorCache().getEliteCraftingCache().isShapeless(), new ButtonState<>(RecipeCreatorCluster.SHAPELESS_ENABLED, PlayerHeadUtils.getViaURL("f21d93da43863cb3759afefa9f7cc5c81f34d920ca97b7283b462f8b197f813"), (cache, guiHandler, player, inventory, slot, event) -> {
        ...
        registerButton(new ToggleButton<>(RecipeCreatorCluster.MIRROR_HORIZONTAL, (cache, g, p, gui, i) -> cache.getRecipeCreatorCache().getEliteCraftingCache().isMirrorHorizontal(), new ButtonState<>(RecipeCreatorCluster.MIRROR_HORIZONTAL_ENABLED, PlayerHeadUtils.getViaURL("956a3618459e43b287b22b7e235ec699594546c6fcd6dc84bfca4cf30ab9311"), (cache, guiHandler, player, inventory, slot, event) -> {
        ...
        registerButton(new ToggleButton<>(RecipeCreatorCluster.MIRROR_VERTICAL, (cache, g, p, gui, i) -> cache.getRecipeCreatorCache().getEliteCraftingCache().isMirrorVertical(), new ButtonState<>(RecipeCreatorCluster.MIRROR_VERTICAL_ENABLED, PlayerHeadUtils.getViaURL("882faf9a584c4d676d730b23f8942bb997fa3dad46d4f65e288c39eb471ce7"), (cache, guiHandler, player, inventory, slot, event) -> {
        ...
        registerButton(new ToggleButton<>(RecipeCreatorCluster.MIRROR_ROTATION, (cache, g, p, gui, i) -> cache.getRecipeCreatorCache().getEliteCraftingCache().isMirrorRotation(), new ButtonState<>(RecipeCreatorCluster.MIRROR_ROTATION_ENABLED, PlayerHeadUtils.getViaURL("e887cc388c8dcfcf1ba8aa5c3c102dce9cf7b1b63e786b34d4f1c3796d3e9d61"), (cache, guiHandler, player, inventory, slot, event) -> {
