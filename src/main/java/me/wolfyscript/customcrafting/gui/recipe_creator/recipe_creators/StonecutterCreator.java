...
import me.wolfyscript.customcrafting.gui.recipe_creator.buttons.StonecutterResultButton;
...
public class StonecutterCreator extends RecipeCreator {
    ...
    public void onInit() {
        ...
        registerButton(new StonecutterResultButton(customCrafting));
    }
    ...
    public boolean validToSave(CCCache cache) {
        ...
        return !InventoryUtils.isCustomItemsListEmpty(recipe.getResults()) && !recipe.getSource().isEmpty();
    }
}
