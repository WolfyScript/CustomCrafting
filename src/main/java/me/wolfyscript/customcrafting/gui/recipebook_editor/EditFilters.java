...
public class EditFilters extends CCWindow {

    public EditFilters(GuiCluster<CCCache> cluster, CustomCrafting customCrafting) {
    ...
    public void onInit() {
        ...
        registerButton(new ActionButton<>("previous", new ButtonState<>("previous", PlayerHeadUtils.getViaURL("ad73cf66d31b83cd8b8644c15958c1b73c8d97323b801170c1d8864bb6a846d"), (cache, guiHandler, player, inventory, slot, event) -> true)));
        registerButton(new ActionButton<>("next", new ButtonState<>("next", PlayerHeadUtils.getViaURL("c86185b1d519ade585f184c34f3f3e20bb641deb879e81378e4eaf209287"), (cache, guiHandler, player, inventory, slot, event) -> true)));
